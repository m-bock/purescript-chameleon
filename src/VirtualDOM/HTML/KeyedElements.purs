...
abbr :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
abbr props children = elemKeyed (ElemName "abbr") props children

-- | Defines an abbreviation [No Attributes]
abbr_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
abbr_ children = elemKeyed (ElemName "abbr") [] children

-- | Defines contact information for the author/owner of a document
address :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
article_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
article_ children = elemKeyed (ElemName "article") [] children

-- | Defines content aside from the content it is placed in
aside :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
aside_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
aside_ children = elemKeyed (ElemName "aside") [] children

-- | Defines sound content, like music or other audio streams
audio :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
datalist_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
datalist_ children = elemKeyed (ElemName "datalist") [] children

-- | Defines a description/value of a term in a description list
dd :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
dd_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
dd_ children = elemKeyed (ElemName "dd") [] children

-- | Defines text that has been deleted from a document
del :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
del props children = elemKeyed (ElemName "del") props children

-- | Defines text that has been deleted from a document [No Attributes]
del_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
del_ children = elemKeyed (ElemName "del") [] children

-- | Defines additional details that the user can view or hide
details :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
embed_ :: forall html ctx a. Html html ctx => html a
embed_ = elemKeyed (ElemName "embed") [] []

-- | Groups related form elements
fieldset :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
fieldset props children = elemKeyed (ElemName "fieldset") props children

-- | Groups related form elements [No Attributes]
fieldset_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
fieldset_ children = elemKeyed (ElemName "fieldset") [] children

-- | Defines a caption for a <figure> element
figcaption :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
figcaption_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
figcaption_ children = elemKeyed (ElemName "figcaption") [] children

-- | Defines self-contained content, like images or diagrams
figure :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
iframe_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
iframe_ children = elemKeyed (ElemName "iframe") [] children

-- | Defines an image
img :: forall html ctx a. Html html ctx => Array (Prop a) -> html a
img props = elemKeyed (ElemName "img") props []

-- | Defines an image [No Attributes]
img_ :: forall html ctx a. Html html ctx => html a
img_ = elemKeyed (ElemName "img") [] []

-- | Defines an input control
input :: forall html ctx a. Html html ctx => Array (Prop a) -> html a
input props = elemKeyed (ElemName "input") props []

-- | Defines an input control [No Attributes]
input_ :: forall html ctx a. Html html ctx => html a
input_ = elemKeyed (ElemName "input") [] []

-- | Defines text that has been inserted into a document
ins :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
meter_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
meter_ children = elemKeyed (ElemName "meter") [] children

-- | Defines a navigation menu
nav :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
nav props children = elemKeyed (ElemName "nav") props children

-- | Defines a navigation menu [No Attributes]
nav_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
nav_ children = elemKeyed (ElemName "nav") [] children

-- | Defines an alternate content for users that do not support client-side scripts
noscript :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
noscript_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
...
object :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
object_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
object_ children = elemKeyed (ElemName "object") [] children

-- | Defines an ordered list
ol :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
ol props children = elemKeyed (ElemName "ol") props children

-- | Defines an ordered list [No Attributes]
ol_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
ol_ children = elemKeyed (ElemName "ol") [] children

-- | Defines a group of related options in a drop-down list
optgroup :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
rtc_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
rtc_ children = elemKeyed (ElemName "rtc") [] children

-- | Defines a ruby annotation (for East Asian typography)
ruby :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
source_ :: forall html ctx a. Html html ctx => html a
source_ = elemKeyed (ElemName "source") [] []

-- | Defines a small section of text
span :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
span props children = elemKeyed (ElemName "span") props children

-- | Defines a small section of text [No Attributes]
span_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
span_ children = elemKeyed (ElemName "span") [] children

-- | Defines important text
strong :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
strong props children = elemKeyed (ElemName "strong") props children

-- | Defines important text [No Attributes]
strong_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
...
sub :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
sub props children = elemKeyed (ElemName "sub") props children

-- | Defines subscripted text [No Attributes]
sub_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
sub_ children = elemKeyed (ElemName "sub") [] children

-- | Defines a visible heading for a <details> element
summary :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
...
summary_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
summary_ children = elemKeyed (ElemName "summary") [] children

-- | Defines superscripted text
sup :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
sup props children = elemKeyed (ElemName "sup") props children

-- | Defines superscripted text [No Attributes]
sup_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
sup_ children = elemKeyed (ElemName "sup") [] children

-- | Defines a table
table :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
table props children = elemKeyed (ElemName "table") props children

-- | Defines a table [No Attributes]
table_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
table_ children = elemKeyed (ElemName "table") [] children

-- | Groups the body content in a table
tbody :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
tbody props children = elemKeyed (ElemName "tbody") props children

-- | Groups the body content in a table [No Attributes]
tbody_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
tbody_ children = elemKeyed (ElemName "tbody") [] children

-- | Defines a cell in a table
td :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
td props children = elemKeyed (ElemName "td") props children

-- | Defines a cell in a table [No Attributes]
td_ :: forall html ctx a. Html html ctx => Array (Key /\ html a) -> html a
td_ children = elemKeyed (ElemName "td") [] children

-- | Defines a container for content that should be hidden when the page loads
template :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (Key /\ html a) -> html a
