...
-- | Defines a hyperlink
a :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
a props children = elem (ElemName "a") props children

-- | Defines a hyperlink [No Attributes]
a_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
a_ children = elem (ElemName "a") [] children

-- | Defines an abbreviation
abbr :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
abbr props children = elem (ElemName "abbr") props children

-- | Defines an abbreviation [No Attributes]
abbr_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
abbr_ children = elem (ElemName "abbr") [] children

-- | Defines contact information for the author/owner of a document
address :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
address_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
article :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
article_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
article_ children = elem (ElemName "article") [] children

-- | Defines content aside from the content it is placed in
aside :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
aside_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
aside_ children = elem (ElemName "aside") [] children

-- | Defines sound content, like music or other audio streams
audio :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
audio_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
audio_ children = elem (ElemName "audio") [] children

-- | Defines bold text
b :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
b props children = elem (ElemName "b") props children

-- | Defines bold text [No Attributes]
b_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
bdi :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
bdi props children = elem (ElemName "bdi") props children

-- | Defines text directionality for its children [No Attributes]
bdi_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
bdi_ children = elem (ElemName "bdi") [] children

-- | Defines text directionality
bdo :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
bdo props children = elem (ElemName "bdo") props children

-- | Defines text directionality [No Attributes]
bdo_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
bdo_ children = elem (ElemName "bdo") [] children

-- | Defines a section that is quoted from another source
blockquote :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
blockquote_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
blockquote_ children = elem (ElemName "blockquote") [] children

-- | Defines the document's body
body :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
body props children = elem (ElemName "body") props children

-- | Defines the document's body [No Attributes]
body_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
canvas_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
canvas_ children = elem (ElemName "canvas") [] children

-- | Defines a table caption
caption :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
caption props children = elem (ElemName "caption") props children

-- | Defines a table caption [No Attributes]
caption_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
caption_ children = elem (ElemName "caption") [] children

-- | Defines the title of a work
cite :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
cite props children = elem (ElemName "cite") props children

-- | Defines the title of a work [No Attributes]
cite_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
cite_ children = elem (ElemName "cite") [] children

-- | Defines a piece of computer code
code :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
code props children = elem (ElemName "code") props children

-- | Defines a piece of computer code [No Attributes]
code_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
colgroup :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
datalist_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
datalist_ children = elem (ElemName "datalist") [] children

-- | Defines a description/value of a term in a description list
dd :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
dd_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
dd_ children = elem (ElemName "dd") [] children

-- | Defines text that has been deleted from a document
del :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
del props children = elem (ElemName "del") props children

-- | Defines text that has been deleted from a document [No Attributes]
del_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
del_ children = elem (ElemName "del") [] children

-- | Defines additional details that the user can view or hide
details :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
html :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
html props children = elem (ElemName "html") props children

-- | Defines the root of an HTML document [No Attributes]
html_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
html_ children = elem (ElemName "html") [] children

-- | Defines italic text
i :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
i props children = elem (ElemName "i") props children

-- | Defines italic text [No Attributes]
i_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
i_ children = elem (ElemName "i") [] children

-- | Defines an inline frame for embedding external content
iframe :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
iframe_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
noscript_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
noscript_ children = elem (ElemName "noscript") [] children

-- | Defines a container for external application or interactive content
object :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
object_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
object_ children = elem (ElemName "object") [] children

-- | Defines an ordered list
ol :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
ol props children = elem (ElemName "ol") props children

-- | Defines an ordered list [No Attributes]
ol_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
ol_ children = elem (ElemName "ol") [] children

-- | Defines a group of related options in a drop-down list
optgroup :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
picture :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
u :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
u props children = elem (ElemName "u") props children

-- | Defines underlined text [No Attributes]
u_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
u_ children = elem (ElemName "u") [] children

-- | Defines an unordered list
ul :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
ul props children = elem (ElemName "ul") props children

-- | Defines an unordered list [No Attributes]
ul_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
ul_ children = elem (ElemName "ul") [] children

-- | Defines a variable
var :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
var props children = elem (ElemName "var") props children

-- | Defines a variable [No Attributes]
var_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
var_ children = elem (ElemName "var") [] children

-- | Defines a video
video :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
video props children = elem (ElemName "video") props children

-- | Defines a video [No Attributes]
video_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
