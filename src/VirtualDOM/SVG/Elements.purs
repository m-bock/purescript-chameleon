...
altGlyph :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
altGlyph_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
altGlyph_ children = elem (ElemName "altGlyph") [] children

-- | Defines a set of glyph substitutions for an altGlyph element
altGlyphDef :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
altGlyphDef_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
altGlyphItem :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
altGlyphItem_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
clipPath :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
clipPath props children = elem (ElemName "clipPath") props children

-- | Defines a clipping path for an SVG element [No Attributes]
clipPath_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
clipPath_ children = elem (ElemName "clipPath") [] children

-- | Defines a color profile for an SVG document
colorProfile :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
colorProfile_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
feMerge :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
feMerge props children = elem (ElemName "feMerge") props children

-- | Merges multiple input images together [No Attributes]
feMerge_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
filter :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
filter props children = elem (ElemName "filter") props children

-- | Defines a filter effect [No Attributes]
filter_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
filter_ children = elem (ElemName "filter") [] children

-- | Inserts a foreign object into an SVG document
foreignObject :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
hatch :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
hatch props children = elem (ElemName "hatch") props children

-- | Defines a hatching pattern [No Attributes]
hatch_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
linearGradient :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
linearGradient_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
linearGradient_ children = elem (ElemName "linearGradient") [] children

-- | Defines a marker symbol to be used with a shape or line
marker :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
marker_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
marker_ children = elem (ElemName "marker") [] children

-- | Defines a mask for an SVG element
mask :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
mask props children = elem (ElemName "mask") props children

-- | Defines a mask for an SVG element [No Attributes]
mask_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
mpath :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
mpath_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
pattern :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
pattern_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
radialGradient :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
radialGradient_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
script :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
script props children = elem (ElemName "script") props children

-- | The script element contains script statements. [No Attributes]
script_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
switch_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
switch_ children = elem (ElemName "switch") [] children

-- | The symbol element defines a reusable graphic element.
symbol :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
textPath_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
tspan :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
tspan_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
use :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
use_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
...
view :: forall html ctx a. Html html ctx => Array (Prop a) -> Array (html a) -> html a
...
view_ :: forall html ctx a. Html html ctx => Array (html a) -> html a
